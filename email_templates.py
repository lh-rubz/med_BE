...
def get_2fa_otp_email(first_name, otp_code):
    """Email template for Two-Factor Authentication OTP"""
    return f"""
    <!DOCTYPE html>
    <html>
    <head>
            ...
            <tr>
                <td align="center">
                    <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #ffffff; max-width: 600px;">
                        ...
                        <tr>
                            <td class="content" style="padding: 40px;">
                                <h2 style="margin: 0 0 16px 0; color: #111827; font-size: 24px; font-weight: 600;">Two-Factor Authentication</h2>
                                <p style="margin: 0 0 8px 0; color: #4b5563; font-size: 16px; line-height: 1.6;">Hello {first_name},</p>
                                <p style="margin: 0 0 24px 0; color: #4b5563; font-size: 16px; line-height: 1.6;">You have requested to log in to your MediScan account. Please use the verification code below to complete your login:</p>
                                
                                <table width="100%" cellpadding="0" cellspacing="0" style="margin: 0 0 24px 0;">
                                    <tr>
                                        <td align="center" class="code-box" style="background-color: #eff6ff; border: 2px solid #60a5fa; border-radius: 8px; padding: 24px;">
                                            <p style="margin: 0 0 8px 0; color: #60a5fa; font-size: 12px; font-weight: 600; text-transform: uppercase; letter-spacing: 1px;">Verification Code</p>
                                            <h1 class="code" style="margin: 0; color: #2563eb; font-size: 36px; font-weight: 700; letter-spacing: 8px; font-family: 'Courier New', monospace;">{otp_code}</h1>
                                        </td>
                                    </tr>
                                </table>
                                
                                <p style="margin: 0 0 8px 0; color: #6b7280; font-size: 14px; line-height: 1.5;">This code will expire in 10 minutes for your security.</p>
                                <p style="margin: 0; color: #9ca3af; font-size: 14px;">If you didn't request this login, please ignore this email and consider changing your password immediately.</p>
                            </td>
                        </tr>
                        <tr>
                            <td class="footer" style="background-color: #f9fafb; padding: 24px 40px; text-align: center; border-top: 1px solid #e5e7eb;">
