"""Script to replace the ChatResource class in vlm_routes.py"""

# Read the current file
with open(r'd:\med_BE\routes\vlm_routes.py', 'r', encoding='utf-8') as f:
    lines = f.readlines()

# Find the ChatResource class (starts at line 502, ends at line 685)
# We'll keep everything before line 502 and replace from there

# Keep lines 1-501
output_lines = lines[:501]

# Add the new ChatResource implementation
new_chat_resource = '''
@vlm_ns.route('/chat')
...
output_lines.append(new_chat_resource)

# Write the new file
with open(r'd:\med_BE\routes\vlm_routes.py', 'w', encoding='utf-8') as f:
    f.writelines(output_lines)

print("✅ ChatResource class replaced successfully!")
